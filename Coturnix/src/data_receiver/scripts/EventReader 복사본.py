...
cred = credentials.Certificate(
    directroy + 'la-prova-firebase-adminsdk-9huj0-3cf67c4d09.json')
firebase_admin.initialize_app(
    cred, {'databaseURL': 'https://la-prova-default-rtdb.firebaseio.com/'})
        ...
        if users != currentU:
            ...
            for row in nodes:  # row - List<Dictionary<string, int>>
                for col in row:  # col - Dictionary<string, int>
                    for c in col.keys():
                        # List<string>v#내용이 같아도 서로 다르다고 인식하는 경우가 있어 자음모음 합쳐줌 출처 : https://jonsyou.tistory.com/26
